...
/// how many semitones a bend is worth is its bend range, which the bend event
/// does not carry and this comparison does not reach. A Take that states no tempo and one that states
